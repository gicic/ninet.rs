 ...
 * Generated for Laravel 5.7.15 on 2019-06-18 07:45:21.
 *
...
namespace App\ShoppingCart\Facades {
    ...
    class Cart {
        ...
        {
            return \App\ShoppingCart\Cart::instance($instance);
        }
        ...
        {
            return \App\ShoppingCart\Cart::currentInstance();
        }
         ...
         *
         * @param array $attributes
         * @return \App\ShoppingCart\CartItem
         * @static
         */
        public static function add($attributes = array())
        {
            return \App\ShoppingCart\Cart::add($attributes);
        }
         ...
         * @static
         */
        public static function removeHostingItemsForDomain($domain)
        {
            return \App\ShoppingCart\Cart::removeHostingItemsForDomain($domain);
        }
         ...
         * @static
         */
        public static function updateItem($rowId, $attributes = array())
        {
            return \App\ShoppingCart\Cart::updateItem($rowId, $attributes);
        }
        ...
        {
            return \App\ShoppingCart\Cart::get($rowId);
        }
        ...
        {
            \App\ShoppingCart\Cart::remove($rowId);
        }
        ...
        {
            return \App\ShoppingCart\Cart::content();
        }

        /**
         *
         *
         * @return \App\ShoppingCart\Collection
         * @static
         */
        public static function mainItems()
        {
            return \App\ShoppingCart\Cart::mainItems();
        }
         ...
         * @static
         */
        public static function additionalItems($parentRowId = null)
        {
            return \App\ShoppingCart\Cart::additionalItems($parentRowId);
        }
         ...
         * @static
         */
        public static function applyPromoCode($promoCode, $system = false)
        {
            return \App\ShoppingCart\Cart::applyPromoCode($promoCode, $system);
        }
        ...
        {
            return \App\ShoppingCart\Cart::clearDiscounts();
        }
        ...
        {
            return \App\ShoppingCart\Cart::count();
        }
         ...
         * @static
         */
        public static function hasCoRsDomain()
        {
            return \App\ShoppingCart\Cart::hasCoRsDomain();
        }
         ...
         * @static
         */
        public static function hasInRsDomain()
        {
            return \App\ShoppingCart\Cart::hasInRsDomain();
        }
         ...
         * @static
         */
        public static function termsAccepted()
        {
            return \App\ShoppingCart\Cart::termsAccepted();
        }
         ...
         * @static
         */
        public static function addDiscountsToItem($rowId, $discounts)
        {
            return \App\ShoppingCart\Cart::addDiscountsToItem($rowId, $discounts);
        }
        ...
        {
            return \App\ShoppingCart\Cart::total($decimals, $decimalPoint, $thousandSeparator);
        }
        ...
        {
            return \App\ShoppingCart\Cart::tax($decimals, $decimalPoint, $thousandSeparator);
        }
        ...
        {
            return \App\ShoppingCart\Cart::subtotal($decimals, $decimalPoint, $thousandSeparator);
        }
        ...
        {
            return \App\ShoppingCart\Cart::backup();
        }
        ...
        {
            return \App\ShoppingCart\Cart::restore();
        }
    ...
    class CartContact {
         ...
         * @static
         */
        public static function set($attributes = array())
        {
            return \App\ShoppingCart\CartContact::set($attributes);
        }
        ...
        {
            return \App\ShoppingCart\CartContact::get();
        }
...
namespace App\SocialNetworks\Facades {
    ...
    class Facebook {
        ...
        {
            return \App\SocialNetworks\Facebook::getAccessToken();
        }

        /**
         *
         *
         * @return \App\SocialNetworks\UserProfile|bool
         * @static
         */
        public static function getUserProfile()
        {
            return \App\SocialNetworks\Facebook::getUserProfile();
        }
...
namespace App\Solus\Facade {
    ...
    class Solus {
        ...
        {
            return \App\Solus\Solus::getParameters();
        }
         ...
         * @static
         */
        public static function console($serverID, $access, $time)
        {
            return \App\Solus\Solus::console($serverID, $access, $time);
        }
         ...
         * @static
         */
        public static function disableTUN($serverID)
        {
            return \App\Solus\Solus::disableTUN($serverID);
        }
         ...
         * @static
         */
        public static function enableTUN($serverID)
        {
            return \App\Solus\Solus::enableTUN($serverID);
        }
         ...
         * @static
         */
        public static function paestatus($serverID, $pae)
        {
            return \App\Solus\Solus::paestatus($serverID, $pae);
        }
         ...
         * @static
         */
        public static function reboot($serverID)
        {
            return \App\Solus\Solus::reboot($serverID);
        }
         ...
         * @static
         */
        public static function boot($serverID)
        {
            return \App\Solus\Solus::boot($serverID);
        }
         ...
         * @static
         */
        public static function shutdown($serverID)
        {
            return \App\Solus\Solus::shutdown($serverID);
        }
         ...
         * @static
         */
        public static function listISO($type)
        {
            return \App\Solus\Solus::listISO($type);
        }
         ...
         * @static
         */
        public static function mountISO($serverID, $iso)
        {
            return \App\Solus\Solus::mountISO($serverID, $iso);
        }
         ...
         * @static
         */
        public static function unmountISO($serverID)
        {
            return \App\Solus\Solus::unmountISO($serverID);
        }
         ...
         * @static
         */
        public static function changeBootOrder($serverID, $bootOrder)
        {
            return \App\Solus\Solus::changeBootOrder($serverID, $bootOrder);
        }
         ...
         * @static
         */
        public static function getVNC($serverID)
        {
            return \App\Solus\Solus::getVNC($serverID);
        }
         ...
         * @static
         */
        public static function getServerInfo($serverID)
        {
            return \App\Solus\Solus::getServerInfo($serverID);
        }
         ...
         * @static
         */
        public static function getServerState($serverID, $nostatus, $nographs)
        {
            return \App\Solus\Solus::getServerState($serverID, $nostatus, $nographs);
        }
         ...
         * @static
         */
        public static function getServerStatus($serverID)
        {
            return \App\Solus\Solus::getServerStatus($serverID);
        }
         ...
         * @static
         */
        public static function authenticateClient($username, $password)
        {
            return \App\Solus\Solus::authenticateClient($username, $password);
        }
         ...
         * @static
         */
        public static function changeHostname($serverID, $hostname)
        {
            return \App\Solus\Solus::changeHostname($serverID, $hostname);
        }
        ...
        {
            return \App\Solus\Solus::createClient($clientData);
        }
         ...
         * @static
         */
        public static function getByEmailOrCreateNew($clientData)
        {
            return \App\Solus\Solus::getByEmailOrCreateNew($clientData);
        }
        ...
        {
            return \App\Solus\Solus::getClientByEmail($email);
        }
         ...
         * @static
         */
        public static function generateUserName($fName, $lName)
        {
            return \App\Solus\Solus::generateUserName($fName, $lName);
        }
         ...
         * @static
         */
        public static function listUserNames()
        {
            return \App\Solus\Solus::listUserNames();
        }
        ...
        {
            return \App\Solus\Solus::listEmails();
        }
        ...
        {
            return \App\Solus\Solus::listClients();
        }
         ...
         * @static
         */
        public static function listServers($nodeid)
        {
            return \App\Solus\Solus::listServers($nodeid);
        }
         ...
         * @static
         */
        public static function createVserver($data)
        {
            return \App\Solus\Solus::createVserver($data);
        }
         ...
         * @return \App\Solus\Collection
         * @throws Exception
         * @static
         */
        public static function listTemplates($type = 'openvz', $listpipefriendly = true)
        {
            return \App\Solus\Solus::listTemplates($type, $listpipefriendly);
        }
         ...
         * @static
         */
        public static function vserverExists($serverID)
        {
            return \App\Solus\Solus::vserverExists($serverID);
        }
         ...
         * @static
         */
        public static function addIP($serverID, $ipv4addr = 0, $forceaddip = 0)
        {
            return \App\Solus\Solus::addIP($serverID, $ipv4addr, $forceaddip);
        }
         ...
         * @static
         */
        public static function deleteIP($serverID, $ipaddr)
        {
            return \App\Solus\Solus::deleteIP($serverID, $ipaddr);
        }
         ...
         * @static
         */
        public static function changeOwner($serverID, $clientID)
        {
            return \App\Solus\Solus::changeOwner($serverID, $clientID);
        }
         ...
         * @static
         */
        public static function changePlan($serverID, $plan, $changeHDD = false)
        {
            return \App\Solus\Solus::changePlan($serverID, $plan, $changeHDD);
        }
         ...
         * @static
         */
        public static function terminate($serverID, $deleteclient = false)
        {
            return \App\Solus\Solus::terminate($serverID, $deleteclient);
        }
         ...
         * @static
         */
        public static function suspend($serverID)
        {
            return \App\Solus\Solus::suspend($serverID);
        }
         ...
         * @static
         */
        public static function unsuspend($serverID)
        {
            return \App\Solus\Solus::unsuspend($serverID);
        }
         ...
         * @static
         */
        public static function changeBandwidth($serverID, $limit, $overlimit)
        {
            return \App\Solus\Solus::changeBandwidth($serverID, $limit, $overlimit);
        }
         ...
         * @static
         */
        public static function changeMemory($serverID, $memory)
        {
            return \App\Solus\Solus::changeMemory($serverID, $memory);
        }
         ...
         * @static
         */
        public static function changeDiskSize($serverID, $hdd)
        {
            return \App\Solus\Solus::changeDiskSize($serverID, $hdd);
        }
         ...
         * @static
         */
        public static function rebuild($serverID, $template)
        {
            return \App\Solus\Solus::rebuild($serverID, $template);
        }
         ...
         * @static
         */
        public static function changeRootPassword($serverID, $rootpassword)
        {
            return \App\Solus\Solus::changeRootPassword($serverID, $rootpassword);
        }
         ...
         * @static
         */
        public static function changeVNCpassword($serverID, $vncpassword)
        {
            return \App\Solus\Solus::changeVNCpassword($serverID, $vncpassword);
        }
         ...
         *
         * @param $type
         * @return \App\Solus\Collection|\Tightenco\Collect\Support\Collection
         * @throws Exception
         * @static
         */
        public static function listPlans($type)
        {
            return \App\Solus\Solus::listPlans($type);
        }
         ...
         * @static
         */
        public static function listNodesByID($type)
        {
            return \App\Solus\Solus::listNodesByID($type);
        }
         ...
         * @static
         */
        public static function listNodesByName($type)
        {
            return \App\Solus\Solus::listNodesByName($type);
        }
         ...
         * @static
         */
        public static function getNodeIPs($nodeid)
        {
            return \App\Solus\Solus::getNodeIPs($nodeid);
        }
         ...
         * @static
         */
        public static function listNodeGroups($type)
        {
            return \App\Solus\Solus::listNodeGroups($type);
        }
...
namespace App\Services\OneTimeSecret\Facade {
    ...
    class OTS {
         ...
         * @static
         */
        public static function getSecretLink($secret)
        {
            return \App\Services\OneTimeSecret\OTS::getSecretLink($secret);
        }
...
namespace App\Services\Eracuni\Facade {
    ...
    class Eracuni {
         ...
         * @static
         */
        public static function PartnerGetByCode($partnerCode)
        {
            return \App\Services\Eracuni\Eracuni::PartnerGetByCode($partnerCode);
        }
        ...
        {
            return \App\Services\Eracuni\Eracuni::PartnerCreate($data);
        }
         ...
         * @static
         */
        public static function SalesInvoiceGet($invoiceNumber)
        {
            return \App\Services\Eracuni\Eracuni::SalesInvoiceGet($invoiceNumber);
        }
         ...
         * @static
         */
        public static function SalesInvoiceCreate($data)
        {
            return \App\Services\Eracuni\Eracuni::SalesInvoiceCreate($data);
        }
...
namespace App\Services\GoDaddy\Facades {
    ...
    class GoDaddyDomain {
         ...
         *
         * @param array $data Possible data parameters:
         ...
         * @static
         */
        public static function getDomains($data = array())
        {
            return \App\Services\GoDaddy\GoDaddyDomain::getDomains($data);
        }
        ...
        {
            return \App\Services\GoDaddy\GoDaddyDomain::getDomain($domain);
        }
         ...
         * @static
         */
        public static function updateDomain($domain, $locked = null, $nameservers = array(), $renewAuto = null)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::updateDomain($domain, $locked, $nameservers, $renewAuto);
        }
         ...
         * @static
         */
        public static function isAvailable($domain, $checkType = 'FAST')
        {
            return \App\Services\GoDaddy\GoDaddyDomain::isAvailable($domain, $checkType);
        }
         ...
         * @static
         */
        public static function isAvailableBulk($domains = array(), $checkType = 'FAST')
        {
            return \App\Services\GoDaddy\GoDaddyDomain::isAvailableBulk($domains, $checkType);
        }
         ...
         * @static
         */
        public static function getAgreements($tlds, $privacy = false, $forTransfer = false)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::getAgreements($tlds, $privacy, $forTransfer);
        }
         ...
         * @param \App\Services\GoDaddy\Consent $consent
         * @param array $contacts : An array of App\Services\GoDaddy\Resource\Contact instances
         * @return mixed
         * @throws GoDaddyException
         * @static
         */
        public static function registerDomain($domain, $consent, $contacts = array())
        {
            return \App\Services\GoDaddy\GoDaddyDomain::registerDomain($domain, $consent, $contacts);
        }
         ...
         * @static
         */
        public static function validateRegistrationSchema($body)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::validateRegistrationSchema($body);
        }
         ...
         * @static
         */
        public static function renewDomain($domain, $period = 1)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::renewDomain($domain, $period);
        }
         ...
         * @static
         */
        public static function updateContacts($domain, $contacts)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::updateContacts($domain, $contacts);
        }
         ...
         * @static
         */
        public static function orderPrivacy($domain, $consent)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::orderPrivacy($domain, $consent);
        }
         ...
         * @static
         */
        public static function cancelPrivacy($domain)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::cancelPrivacy($domain);
        }
         ...
         * @static
         */
        public static function transferIn($domain, $authCode, $consent, $privacy = false, $period = null)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::transferIn($domain, $authCode, $consent, $privacy, $period);
        }
         ...
         * @param bool $privacy
         * @param bool $transfer
         * @return \App\Services\GoDaddy\Consent
         * @throws GoDaddyException
         * @static
         */
        public static function getConsent($extension, $privacy = false, $transfer = false)
        {
            return \App\Services\GoDaddy\GoDaddyDomain::getConsent($extension, $privacy, $transfer);
        }
         ...
         * @static
         */
        public static function makeRequest($requestMethod, $url, $data = array(), $body = null, $additionalHeaders = array())
        {
            //Method inherited from \App\Services\GoDaddy\GoDaddyClient
            return \App\Services\GoDaddy\GoDaddyDomain::makeRequest($requestMethod, $url, $data, $body, $additionalHeaders);
        }
         ...
         * @static
         */
        public static function StatusCodeHandling($response)
        {
            //Method inherited from \App\Services\GoDaddy\GoDaddyClient
            return \App\Services\GoDaddy\GoDaddyDomain::StatusCodeHandling($response);
        }
...
namespace App\Services\Rnids\Facades {
    ...
    class Rnids {
        ...
        {
            return \App\Services\Rnids\Rnids::greet();
        }
        ...
        {
            return \App\Services\Rnids\Rnids::login();
        }
        ...
        public static function logout()
        {
            return \App\Services\Rnids\Rnids::logout();
        }
         ...
         * @static
         */
        public static function registerDomain($domain, $interval = 1, $contacts_data = array(), $nameservers = array(), $whois = false)
        {
            return \App\Services\Rnids\Rnids::registerDomain($domain, $interval, $contacts_data, $nameservers, $whois);
        }
         ...
         * @static
         */
        public static function nameserverIsSubdomain($nameserver, $domain_name)
        {
            return \App\Services\Rnids\Rnids::nameserverIsSubdomain($nameserver, $domain_name);
        }
         ...
         * @static
         */
        public static function createContact($contact_data)
        {
            return \App\Services\Rnids\Rnids::createContact($contact_data);
        }
         ...
         * @static
         */
        public static function renewDomain($domain, $interval = 1, $whois = false)
        {
            return \App\Services\Rnids\Rnids::renewDomain($domain, $interval, $whois);
        }
         ...
         *
         * @param $domains
         * @return array|bool|\App\Services\Rnids\eppResponse|null
         * @static
         */
        public static function isAvailable($domains)
        {
            return \App\Services\Rnids\Rnids::isAvailable($domains);
        }
        ...
        {
            return \App\Services\Rnids\Rnids::getLanguage();
        }
        ...
        {
            return \App\Services\Rnids\Rnids::setLanguage($lang);
        }
         ...
         * @static
         */
        public static function setDomainLocking($domain, $lock)
        {
            return \App\Services\Rnids\Rnids::setDomainLocking($domain, $lock);
        }
         ...
         * @static
         */
        public static function updateDomain($domain, $registrant = null, $admincontact = null, $techcontact = null, $nameservers = null, $statuses = null, $operationMode = null)
        {
            return \App\Services\Rnids\Rnids::updateDomain($domain, $registrant, $admincontact, $techcontact, $nameservers, $statuses, $operationMode);
        }
         ...
         * @static
         */
        public static function setNameservers($domain, $nameservers)
        {
            return \App\Services\Rnids\Rnids::setNameservers($domain, $nameservers);
        }
        ...
        {
            return \App\Services\Rnids\Rnids::getNameservers($domain);
        }
        ...
        {
            return \App\Services\Rnids\Rnids::infoDomain($domain);
        }
         ...
         * @static
         */
        public static function checkContact($contactID)
        {
            return \App\Services\Rnids\Rnids::checkContact($contactID);
        }
         ...
         * @static
         */
        public static function transferInApprove($domain, $auth_code)
        {
            return \App\Services\Rnids\Rnids::transferInApprove($domain, $auth_code);
        }
...
namespace App\Services\Resello\Facades {
    ...
    class Resello {
        ...
        {
            return \App\Services\Resello\Resello::getAllDomains();
        }
         ...
         * @static
         */
        public static function registerDomain($domain, $interval_months = 12, $customer_data = array())
        {
            return \App\Services\Resello\Resello::registerDomain($domain, $interval_months, $customer_data);
        }
        ...
        public static function renewDomain($domain, $interval = 1, $whois = false)
        {
            return \App\Services\Resello\Resello::renewDomain($domain, $interval, $whois);
        }
        ...
        {
            return \App\Services\Resello\Resello::createCustomer($data);
        }
         ...
         * @static
         */
        public static function customerExists($customer_email)
        {
            return \App\Services\Resello\Resello::customerExists($customer_email);
        }
         ...
         * @static
         */
        public static function getCustomer($customer_email)
        {
            return \App\Services\Resello\Resello::getCustomer($customer_email);
        }
        ...
        {
            return \App\Services\Resello\Resello::isAvailable($domain);
        }
        ...
        public static function infoDomain($domain)
        {
            return \App\Services\Resello\Resello::infoDomain($domain);
        }
        ...
        public static function setNameservers($domain, $nameservers)
        {
            return \App\Services\Resello\Resello::setNameservers($domain, $nameservers);
        }
        ...
        public static function getNameservers($domain)
        {
            return \App\Services\Resello\Resello::getNameservers($domain);
        }
        ...
        {
            return \App\Services\Resello\Resello::getErrors();
        }
...
namespace App\Services\RealTime\Facades {
    ...
    class RealTime {
         ...
         * @static
         */
        public static function registerDomain($domain, $interval_months = 12, $customer_data = array(), $nameservers = array(), $whois = false)
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->registerDomain($domain, $interval_months, $customer_data, $nameservers, $whois);
        }
         ...
         * @static
         */
        public static function renewDomain($domain, $interval)
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->renewDomain($domain, $interval);
        }
        ...
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->isAvailable($domain);
        }
        ...
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->setNameservers($domain, $nameservers);
        }
        ...
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->getNameservers($domain);
        }
         ...
         * @return mixed
         */
        public static function info($domain_name)
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->info($domain_name);
        }
         ...
         * @static
         */
        public static function transferIn($domainName, $customer, $authCode, $privacy = false, $period = null)
        {
            /** @var \App\Services\RealTime\RealTime $instance */
            return $instance->transferIn($domainName, $customer, $authCode, $privacy = false, $period = null);
        }
    }
...
namespace App\Services\Domains\Facades {
    ...
    class Domains {
         ...
         * @static 
         */ 
        public static function isAvailable($domainExtension, $domainName)
        {
            return \App\Services\Domains\Domains::isAvailable($domainExtension, $domainName);
        }
         ...
         * @static 
         */ 
        public static function registerDomain($orderDetail)
        {
            return \App\Services\Domains\Domains::registerDomain($orderDetail);
        }
         ...
         * @static 
         */ 
        public static function registerReselloDomain($orderDetail)
        {
            return \App\Services\Domains\Domains::registerReselloDomain($orderDetail);
        }
...
namespace App\Services\CoreAPI\Facades { 
    ...
    class CoreAPI {
        ...
        {
            return \App\Services\CoreAPI\CoreAPI::getClientAccessToken();
        }
        ...
        public static function makeRequest($requestMethod, $url, $data = array(), $body = null, $additionalHeaders = array())
        {
            return \App\Services\CoreAPI\CoreAPI::makeRequest($requestMethod, $url, $data, $body, $additionalHeaders);
        }
        ...
        public static function StatusCodeHandling($response)
        {
            return \App\Services\CoreAPI\CoreAPI::StatusCodeHandling($response);
        }
    ...
    class ExternalResource {
         ...
         * @static 
         */ 
        public static function createOrderExternalResource($orderId)
        {
            return \App\Services\CoreAPI\ExternalResource::createOrderExternalResource($orderId);
        }
         ...
         * @static
         */
        public static function renewOrderExternalResource($orderId)
        {
            return \App\Services\CoreAPI\ExternalResource::renewOrderExternalResource($orderId);
        }
    }
...
namespace  { 
    ...
    class Cart extends \App\ShoppingCart\Facades\Cart {}
    ...
    class Facebook extends \App\SocialNetworks\Facades\Facebook {}

    class Google extends \App\SocialNetworks\Facades\Google {}

    class Solus extends \App\Solus\Facade\Solus {}

    class CartContact extends \App\ShoppingCart\Facades\CartContact {}

    class OTS extends \App\Services\OneTimeSecret\Facade\OTS {}

    class Eracuni extends \App\Services\Eracuni\Facade\Eracuni {}

    class GoDaddyDomain extends \App\Services\GoDaddy\Facades\GoDaddyDomain {}

    class Rnids extends \App\Services\Rnids\Facades\Rnids {}

    class Resello extends \App\Services\Resello\Facades\Resello {}

    class Domains extends \App\Services\Domains\Facades\Domains {}

    class CoreAPI extends \App\Services\CoreAPI\Facades\CoreAPI {}

    class ExternalResource extends \App\Services\CoreAPI\Facades\ExternalResource {}

    ...
    <section class="bp-purchased-section">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <div class="text">
                        <p class="text1 text-uppercase">{{ __('main.card_payment_success') }}: {{ number_format($totalAmount, 2) }} RSD</p>
                        <p class="text2">{{ __('main.order_success_2') }} </p>
                        <p class="text3">{{ __('main.order_success_3') }}: <br />
                            <a href="tel:{{ __('company.phone_1') }}" class="phone">{{ __('company.phone_1') }}</a> {{ __('main.order_success_3_or') }} <a href="mailto:helpdesk@webglobe.rs">helpdesk@webglobe.rs</a>
                        </p>

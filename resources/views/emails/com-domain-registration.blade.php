...
Promene na domenu (DNS, A, CNAME…) možete vršiti preko Vašeg korisnickog naloga na https://cp.ninet.rs/ ili možete nam se obratiti na mail support@ninet.rs
...
Please verify the registration and the domain name data (check also SPAM/JUNK folder). <br>

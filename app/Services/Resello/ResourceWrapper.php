...
class ResourceWrapper
{
    ...
    protected function get_request_path($path_name, $parameters = array())
    {
        ...
        {
            throw new HostControlAPIClientError(null, 'Please provide a paths attribute.');
        }
        ...
        foreach($parameters as $parameter)
        {
            ...
            {
                throw new HostControlAPIClientError(null, 'Invalid parameter for URL resolving.');
            }
        }

        if(! array_key_exists($path_name, $this->paths))
        {
            throw new HostControlAPIClientError(null, 'Path does not exist.');
        }
